...
This is the C# version. We also have a [VB.NET version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_RawDemo_VB_x64) available.
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_RawDemo_CS_x64.git RawDemo
```
